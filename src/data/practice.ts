...
export const PRACTICE_BY_SUBJECT: Record<Subject, Question[]> = {
  ...
  English: [
    ...
    },
    {
      id: 'eng-055',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The strait that separates San Francisco Bay from the Pacific Ocean [BLANK] subject to powerful tidal currents, frequent thick fog, and wind gusts."',
      choices: [
        { id: 'A', text: 'are' },
        { id: 'B', text: 'is' },
        { id: 'C', text: 'being' },
      ...
      answer: 'B',
      explanation: 'The subject is "The strait" (singular), so the verb must be singular: "is." The prepositional phrase "that separates ... Ocean" is a modifier and does not change the subject.',
    },
    {
      id: 'eng-056',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "Neither the coach nor the players [BLANK] aware of the rule change before the game began."',
      choices: [
        { id: 'A', text: 'were' },
        { id: 'B', text: 'was' },
        { id: 'C', text: 'is' },
      ...
      answer: 'A',
      explanation: 'With "neither...nor," the verb agrees with the subject closest to it. "Players" is plural, so the verb is "were."',
    },
    {
      id: 'eng-057',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "Each of the submitted essays [BLANK] reviewed by two independent judges."',
      choices: [
        { id: 'A', text: 'were' },
        { id: 'B', text: 'have been' },
        { id: 'C', text: 'was' },
      ...
      answer: 'C',
      explanation: '"Each" is always singular. Even though "essays" is plural, the subject "Each" requires a singular verb: "was."',
    },
    {
      id: 'eng-058',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The committee, after weeks of heated debate, [BLANK] finally reached a unanimous decision."',
      choices: [
        { id: 'A', text: 'have' },
        { id: 'B', text: 'has' },
        { id: 'C', text: 'having' },
      ...
      answer: 'B',
      explanation: '"The committee" is a collective noun treated as singular in American English, so it takes "has." The phrase "after weeks of heated debate" is a parenthetical and does not affect subject-verb agreement.',
    },
    {
      id: 'eng-059',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "Before [BLANK] the experiment, the researcher reviewed all safety protocols."',
      choices: [
        { id: 'A', text: 'beginning' },
        { id: 'B', text: 'she began' },
        { id: 'C', text: 'to begin' },
        { id: 'D', text: 'having began' },
      ],
      answer: 'A',
      explanation: 'After the preposition "Before," a gerund (verb+ing) is required. "Beginning" is the correct gerund form. "Having began" is also incorrect because the past participle of begin is "begun," not "began."',
    },
    {
      id: 'eng-060',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The data collected over ten years [BLANK] that average temperatures have risen significantly."',
      choices: [
        { id: 'A', text: 'suggest' },
        { id: 'B', text: 'suggests' },
        { id: 'C', text: 'are suggesting' },
        { id: 'D', text: 'have suggested' },
      ],
      answer: 'B',
      explanation: '"Data" used as a mass noun (common in scientific writing) takes a singular verb. Even if treated as plural, the head noun here functions as a collective unit, and "suggests" matches the academic register of the sentence.',
    },
    {
      id: 'eng-061',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "Running along the shore at dawn, [BLANK] shorebirds scattered in every direction."',
      choices: [
        { id: 'A', text: 'the waves caused' },
        { id: 'B', text: 'Maya startled the' },
        { id: 'C', text: 'the' },
        { id: 'D', text: 'it was Maya who startled' },
      ],
      answer: 'B',
      explanation: 'The participial phrase "Running along the shore at dawn" must modify the sentence\'s subject. Only Choice B makes Maya the subject who is running, avoiding a dangling modifier.',
    },
    {
      id: 'eng-062',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The teacher gave the assignment to Marcus and [BLANK]."',
      choices: [
        { id: 'A', text: 'I' },
        { id: 'B', text: 'myself' },
        { id: 'C', text: 'me' },
      ...
      answer: 'C',
      explanation: 'After a preposition ("to"), an object pronoun is required. "Me" is the object form. Test: "gave the assignment to me" -- correct. "Gave the assignment to I" -- incorrect.',
    },
    {
      id: 'eng-063',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "By the time the rescue team arrived, the hikers [BLANK] in the cave for nearly eighteen hours."',
      choices: [
        { id: 'A', text: 'waited' },
      ...
      answer: 'C',
      explanation: 'The past perfect progressive ("had been waiting") is correct here because the waiting began and continued up to a past reference point ("when the rescue team arrived"). It shows duration before another past event.',
    },
    {
      id: 'eng-064',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The report, along with several supporting documents, [BLANK] submitted to the board last Tuesday."',
      choices: [
        { id: 'A', text: 'were' },
        { id: 'B', text: 'was' },
        { id: 'C', text: 'have been' },
      ...
      answer: 'B',
      explanation: '"Along with several supporting documents" is a parenthetical phrase, not a compound subject. The true subject is "The report" (singular), so the singular verb "was" is correct.',
    },
    {
      id: 'eng-065',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The scientist who discovered the compound, as well as her colleagues, [BLANK] honored at the ceremony."',
      choices: [
        { id: 'A', text: 'were' },
        { id: 'B', text: 'was' },
        { id: 'C', text: 'are' },
      ...
      answer: 'B',
      explanation: '"As well as her colleagues" is a parenthetical addition, not a conjunction creating a compound subject. The subject remains "The scientist" (singular), requiring "was."',
    },
    {
      id: 'eng-066',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The students were unsure of [BLANK] turn it was to present."',
      choices: [
        { id: 'A', text: 'who\'s' },
        { id: 'B', text: 'whom\'s' },
        { id: 'C', text: 'whose' },
      ...
      answer: 'C',
      explanation: '"Whose" is the possessive form of "who" and correctly shows ownership of "turn." "Who\'s" is a contraction of "who is" and does not work here grammatically.',
    },
    {
      id: 'eng-067',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The coach told the players that they need to practice more consistently, [BLANK] they hoped to qualify for the finals."',
      choices: [
        { id: 'A', text: 'so' },
        { id: 'B', text: 'but' },
        { id: 'C', text: 'if' },
      ...
      answer: 'C',
      explanation: '"If" correctly introduces a conditional clause showing that consistent practice is a requirement for qualifying. "So" would imply result, "but" would imply contrast, and "nor" would imply negation -- none of which fit the meaning.',
    },
    {
      id: 'eng-068',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The novel that the class discussed [BLANK] written in the nineteenth century."',
      choices: [
        { id: 'A', text: 'was' },
        { id: 'B', text: 'were' },
        { id: 'C', text: 'had' },
      ...
      answer: 'A',
      explanation: '"The novel" is singular and the context requires past passive voice ("was written"). "Were" is plural and incorrect; "had" alone cannot complete the passive construction.',
    },
    {
      id: 'eng-069',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "The team celebrated [BLANK] victory with a parade through the city center."',
      choices: [
        { id: 'A', text: 'their' },
        { id: 'B', text: 'its' },
        { id: 'C', text: 'there' },
      ...
      answer: 'A',
      explanation: 'In American English, collective nouns like "team" can take either singular or plural pronouns; when emphasizing the members acting together, "their" is the most natural and widely accepted choice. "There" is an adverb/location word; "it\'s" means "it is."',
    },
    {
      id: 'eng-070',
      subject: 'English',
      prompt: 'Which choice makes the underlined portion most grammatically acceptable? "Between you and [BLANK], the project deadline seems unrealistic."',
      choices: [
        { id: 'A', text: 'I' },
        { id: 'B', text: 'myself' },
        { id: 'C', text: 'we' },
      ...
      answer: 'D',
      explanation: '"Between" is a preposition that requires an object pronoun. "Me" is the correct object form. "Between you and I" is a common but grammatically incorrect hypercorrection.',
    },
  ],
